  ...
  return (
    <div onClick={() => {
        ...
        <div className='relative h-48 overflow-hidden'>
            ...
            {car.isAvailable && (
                <p className='absolute top-4 left-4 bg-purple-500 text-zinc-100 text-xs font-medium px-2.5 py-1 rounded-full shadow:md'>Available Now</p>
            )}

            <div className='absolute bottom-4 right-4 bg-black/80 backdrop-blur-sm text-white px-3 py-2 rounded-lg'>
                <span className='font-semibold'>{currency}{car.pricePerDay}</span>
                <span className='text-sm text-shadow-white'> / day</span>
            </div>
        </div>
